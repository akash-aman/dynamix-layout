      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Try the full-featured demo with draggable tabs, resizable panels, and dynamic splits. 
            See how easy it is to create VS Code-like interfaces.
          </p>
        </div>
        ...
        <Card className="relative bg-card/50 backdrop-blur-sm border-primary/20 overflow-hidden shadow-card">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border/50 bg-muted/30">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium">Dynamix Layout Demo</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              <Button 
                ...
                onClick={() => window.open('https://dynamix-layout-shadcn.vercel.app/', '_blank')}
              >
          ...
          <div className="relative">
            ...
            {/* Loading overlay */}
            <div className="absolute inset-0 bg-muted/20 backdrop-blur-sm flex items-center justify-center pointer-events-none opacity-0 transition-opacity duration-300" id="demo-loading">
